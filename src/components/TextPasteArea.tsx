          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h2 className="text-base font-bold text-slate-900">Lexim Nepal DSR — Client View</h2>
              ...
              <p className="text-xs text-slate-600 mt-1">
                Live synchronized DSR metrics, distributor performance analytics, and report tables are automatically shared in real-time across all devices.
              </p>
            </div>
          </div>
          {onSwitchToAdmin && (
